...
print(The product of the three numbers is <sum>)
# 3. round the three numbers to the nearest integer and print the sum of the three rounded numbers divided by 3 
print(round the three numbers to the nearest integer and print the sum of the three eounded numbers divided by 3)
